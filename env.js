...
export const REDIS_PORT = process.env.REDIS_PORT || 15345;
export const REDIS_HOST = process.env.REDIS_HOST || 'redis-15345.c2.eu-west-1-3.ec2.cloud.redislabs.com';
export const REDIS_PASSWORD = process.env.REDIS_PASSWORD || 'h8BopVBGxDRzc47LIfSk3HlVLN5V0nng';
